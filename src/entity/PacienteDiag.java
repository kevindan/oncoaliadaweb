...
public class PacienteDiag {
	...
	public PacienteDiag(int paciente_id, int tipo_documento_id, String numero_documento, String nombres,
			...
			String codigo_ubigeo, String fecha_diagnostico, String observacion) {
