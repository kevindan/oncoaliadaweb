...
public class Localizacion_metastasis {

    private int localizacion_metastasis_id;
    private String localizacion_metastasis;
    private int eliminado;

    public Localizacion_metastasis() {
    }

    public Localizacion_metastasis(int localizacion_metastasis_id, String localizacion_metastasis, int eliminado) {
